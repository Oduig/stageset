...
class StageSetConfiguration() {
  ...
  @Bean
  fun cors(stageSetConfigProperties: StageSetConfigProperties): CorsConfigProperties =
      stageSetConfigProperties.cors!!

  @Bean
  fun webClient(stageSetConfigProperties: StageSetConfigProperties): WebClientConfigProperties =
      stageSetConfigProperties.webClient!!
